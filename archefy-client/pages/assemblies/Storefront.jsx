...
export default function Storefront({ collections, trendingProducts }) {
  const [open, setOpen] = useState(false);
  const trendingRef = useRef(null);
  const [authSlideOver, setAuthSlideOver] = useState(false);
  ...
  return (
    <>
      <Slideover open={authSlideOver} setOpen={setAuthSlideOver} />
      <div className="bg-white">
        ...
        <main>
          ...
          <div className="relative">
            ...
            <div className="relative max-w-3xl mx-auto pb-96 px-4 text-center sm:pb-0 sm:px-6 lg:px-8">
              ...
              <div className="relative py-32">
                <h1 className="absolute text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl blur-lg">
                  The Web3.0 Online Shopping Experience
                </h1>
                <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">
                  The Web3.0 Online Shopping Experience
                </h1>
                <div className="mt-8 sm:mt-12 flex space-x-6 items-center justify-center whitespace-nowrap">
                  <button
                    href="#"
                    className="inline-block bg-green-700 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-green-800"
                  >
                    Invest Now
                  </button>
                  <button
          ...
          <section aria-labelledby="trending-heading" ref={trendingRef}>
